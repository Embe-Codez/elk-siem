...
class KibanaDashboard:
    ...
    def clean_data(self, data):
        try:
            ...
            return df
        except (pd.JSONDecodeError, KeyError, ValueError) as e:
            raise DataParsingError("Error occurred during data parsing") from e
    ...
    def create_visualizations(self):
        try:
            ...
            raise VisualizationError("Error occurred during visualization creation") from e
